...
object Dependencies {
  ...
  lazy val circeLiteral =
    "io.circe" %% "circe-literal" % "0.14.15" // used for test only
  lazy val circeParser =
    "io.circe" %% "circe-parser" % "0.14.15" // used for site only
  ...
  lazy val logback = "ch.qos.logback" % "logback-classic" % "1.5.30"
  lazy val logstash =
  ...
  lazy val slf4jDepedency = "org.slf4j" % "slf4j-api" % "2.0.17"
  lazy val sourcecode = "com.lihaoyi" %% "sourcecode" % "0.4.4"
