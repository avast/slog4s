...
/**
  * Mock implementation of [[LoggingRuntime]]. It includes mock implementations of both
  * [[slog4s.LoggerFactory]] and [[slog4s.LoggingContext]] that are integrated with each other.
  */
class MockLoggingRuntime[F[_]](val loggerFactory: MockLoggerFactory[F])(
    implicit val loggingContext: MockLoggingContext[F]
