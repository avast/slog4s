...
// statsDServer: InetSocketAddress = localhost:8125
val config = StatsDMetricFactoryConfig("my-app-name", statsDServer)
// config: StatsDMetricFactoryConfig = StatsDMetricFactoryConfig(
//   "my-app-name",
//   localhost:8125,
//   Vector(),
//   1.0,
...
// factoryResource: Resource[IO, MetricFactory[IO]] = Bind(
//   Allocate(
//     Map(
//       Delay(
//         com.avast.datadog4s.StatsDMetricFactory$$$Lambda$10989/471769403@3823d321
//       ),
//       scala.Function1$$Lambda$67/707976812@2a440436,
//       1
//     )
//   ),
//   cats.effect.Resource$$Lambda$10999/1585854633@2ef420e3
// )
```
...
// res0: IO[Unit] = Async(
//   cats.effect.internals.IOBracket$$$Lambda$11004/223425535@4c73a7e5,
//   false
// )
```
...
// res1: IO[Nothing] = Async(
//   cats.effect.internals.IOBracket$$$Lambda$11004/223425535@6a6fdf91,
//   false
// )
```
...
// statusCodeTagValue: TagValue[StatusCode] = com.avast.datadog4s.api.tag.TagValue$$anonfun$contramap$2@6000035e

val pathTagger: Tagger[String] = Tagger.make[String]("path")
// pathTagger: Tagger[String] = com.avast.datadog4s.api.tag.Tagger$$anon$1@6ffcc485
val statusCodeTagger: Tagger[StatusCode] = Tagger.make[StatusCode]("statusCode")
// statusCodeTagger: Tagger[StatusCode] = com.avast.datadog4s.api.tag.Tagger$$anon$1@3ee10a10
...
// res5: IO[Unit] = Async(
//   cats.effect.internals.IOBracket$$$Lambda$11004/223425535@2a66c90a,
//   false
// )
```
...
// jvmMonitoring: Resource[IO, Unit] = Bind(
//   Bind(
//     Allocate(
//       Map(
//         Delay(
...
// res6: IO[Unit] = Async(
//   cats.effect.internals.IOBracket$$$Lambda$11004/223425535@4a1c25eb,
//   false
// )
```
